...
namespace JapGTelecom.Controllers
{
    public class MobilesController : Controller
    {
        ...
        public MobilesController(JapGTelecomContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Company,ModelNo,Feature,Price")] Mobile mobile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Company,ModelNo,Feature,Price")] Mobile mobile)
        {
            if (id != mobile.id)
            {
                return NotFound();
